...
--
-- Host: localhost
-- Generation Time: Dec 11, 2019 at 07:44 PM
...
--
CREATE DATABASE IF NOT EXISTS `sargatech_training` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `sargatech_training`;
...
(1, 'Administration', 1, 'A Salesforce Administrator is a business leader, deeply knowledgeable about how their company operates, intertwined in making all departments successful through process automations, and thus, integral to running a smooth & lean business.\n \nSalesforce Admins work hard to fight inefficiency and champion productivity. They create awesome tools on any device – like easy to use dashboards, intelligent workflows and apps for any project.\n \nAdmins keep Salesforce users trained and educated, solve complicated business problems and keep projects moving forward.  A Salesforce Admin delivers creative solutions – making Salesforce users happier and the business smarter!', '<p>\nIntroduction to Salesforce .<br />\nProduction and Sandbox Environment.<br />\nCreating a new Application.<br />\nCreating an Output.<br />\nCreate a Tab.<br />\nCreating Custom field.<br />\nCustom Validation Rules.<br />\nSearch Layout, Inline Editing, Enhanced List View and Record Ids.<br />\nCreating Relationship.<br />\nPage Layout and Mini Page layout.<br />\nRecord Types.<br />\nField history Tracking and Activities.<br />\nSecurity in Salesforce.<br />\nImport Wizard and Data Loader.<br />\nWorkflow Rules.<br />\nApproval Process.<br />\nLightning Process Builder.<br />\nReports and Dashboards.<br />\n Web to Load and Web to Case.<br />\nRules on Leads and Cases.<br />\nLightning Experience Introduction.<br />\nUnderstanding Lightning Experience as a Administrator.<br />\nUnderstanding Lightning Experience Features of Opportunities, Leads and Activities.<br />\n</p>', 1),
...
DROP TABLE IF EXISTS `interview_section`;
